...
from .routers import (
    cards, deck_presets, decks, fsrs, import_export, media, notes, notetypes, preferences, review,
    search, stats, system, tags, tts, typing_answer, undo, util,
)
...
def create_app(settings: Settings | None = None) -> FastAPI:
    ...
    for module in (system, decks, deck_presets, notes, notetypes, cards, review, search, tags,
                   stats, preferences, media, import_export, fsrs, undo, typing_answer, tts, util):
