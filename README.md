...
Early build. The v1 milestone covers the `[core]` API surface plus two reviewer
"blockers" (type-in-the-answer, TTS). See [`docs/api-surface-v1.md`](docs/api-surface-v1.md)
for the full designed surface and [`_dev/experiments/`](_dev/experiments/) for
the feasibility spikes the design is grounded in.
